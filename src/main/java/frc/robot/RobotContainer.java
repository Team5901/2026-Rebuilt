...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        ).onFalse(Commands.runOnce(() -> INDEXER.setWantedState(IndexerState.IDLE)));
        joystick.rightTrigger().onTrue(
            Commands.runOnce(() -> SHOOTER.setWantedState(ShooterState.ON))
        ).onFalse(Commands.runOnce(() -> SHOOTER.setWantedState(ShooterState.IDLE)));
        joystick.leftTrigger().onTrue(
            Commands.runOnce(() -> INTAKE.setWantedState(IntakeState.ON))
